                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col s6">
                                <h6>Price: {{$product->price}}<i class="material-icons prefix tiny">euro</i></h6>
                            </div>
                            <div class="input-field col s8">
                                <input id="in_stock" type="number" class="validate in_stock" value="{{$product->in_stock}}">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#in_stock').focusout(function () {
                $.ajax({
                    url: "/manager/products/{{$product->id}}/stock/"+$(this).val(),
                    method: 'GET',
                    dataType: 'JSON',
