<?php $__env->startSection('content'); ?>
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col s6">
                                <h6>Price: <?php echo e($product->price); ?><i class="material-icons prefix tiny">euro</i></h6>
                            </div>
                            <div class="input-field col s8">
                                <input id="in_stock" type="number" class="validate in_stock" value="<?php echo e($product->in_stock); ?>">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#in_stock').focusout(function () {
                $.ajax({
                    url: "/manager/products/<?php echo e($product->id); ?>/stock/"+$(this).val(),
                    method: 'GET',
                    dataType: 'JSON',
                    success: function(result, status, statusCode){
                        if(statusCode.status==201){
                            M.toast({html: 'Stock quantity changed successfully'});
...
<?php /* C:\Users\tajda\Desktop\software-project\resources\views/manager/product/update.blade.php */ ?>